...
import type { Category as _Category, Product as _Product, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: Category, arg4: string, arg5: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getOrderHistory(arg0: Principal): Promise<Array<Order>> {
        if (this.processError) {
            try {
    ...
    async seedWithSampleProducts(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedWithSampleProducts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: Category, arg5: string, arg6: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, arg2, arg3, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg4), arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "groceries" in value ? Category.groceries : "snacks" in value ? Category.snacks : "beverages" in value ? Category.beverages : "personalCare" in value ? Category.personalCare : "household" in value ? Category.household : value;
}
